...
public class Excontroller {
	...
	@RequestMapping("/ex5") // 커맨드객체 없이 파라미터 localhost:8081/ex5?username=xxx&age=20
	public String ex5(String username, Integer age) { // 초기값 필요시 @RequestParam(required = false, defaultValue = "10")
